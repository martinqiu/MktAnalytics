...
- Dataset KPI cards (3,492 rows, 14.2% fraud rate)
- Class distribution pie chart
- Interactive feature histograms by class
...
- Pre-loaded leaderboard from `fraud_results.csv`
- Sortable metric comparison (F1, AUC, Accuracy, Precision, Recall)
- Gold/Silver/Bronze medal rankings
- ROC curves for top 3
- Interactive confusion matrix selector

### Tab 3 — Hyperparameter Tuning
- Select any of 8 models
- Adjust hyperparameters via sliders/dropdowns
- Retrain + display metrics
